	...
	$("#hitung-pinjaman #hitung").on('click',function(){
		...
		if ($("#hitung-pinjaman [name=dana_maksimal]").is(':checked')) {
			...
			window.open("https://api.whatsapp.com/send?phone="+no_hp_replace+"&asdftext=Hallo%20Admin,%0ASaya%20mau%20tanya%20hitungan%20pinjaman:%0A*Dana Pinjaman*:Maksimal%0A*Tenor*:"+tenor+"%0A*Kota%2fKabupaten*:"+kota+"%0A*Merek,%20Tipe%20%26%20Tahun*:"+merek+"%0ATerimakasih", '_blank');
		} else {
			window.open("https://api.whatsapp.com/send?phone="+no_hp_replace+"&text=Hallo%20Admin,%0ASaya%20mau%20tanya%20hitungan%20pinjaman:%0A*Dana Pinjaman*:"+jml_dana+"%0A*Tenor*:"+tenor+"%0A*Kota%2fKabupaten*:"+kota+"%0A*Merek,%20Tipe%20%26%20Tahun*:"+merek+"%0ATerimakasih", '_blank');
		}
	});
